<%@ Page Title="" Language="C#" MasterPageFile="~/Source/Pages/MP.Master" AutoEventWireup="true" CodeBehind="FrmPerfil.aspx.cs" Inherits="ASP_SP.Source.Pages.FrmPerfil" %>
                        ...
                        <fieldset>
                            ...
                            <asp:table runat="server">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox runat="server" CssClass="form-control" ID="tbUsuario" Enable="false" />
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
                                    ...
                                    <asp:TableCell>
                                        <asp:Button runat="server" CssClass="form-control btn btn-sucess" ID="btnGuardar" Text="Guardar" OnClick="btnGuardar_Click" Visible="false"></asp:Button>
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:table>
